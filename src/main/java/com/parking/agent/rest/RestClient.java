package com.parking.agent.rest;
...
public class RestClient
{
     ...
     */
    public Response post(URI uri, String body, Cookie apiKey)
    {
        validateParameters(uri, body);

        return executeRequestAndReturnResponse(HttpMethod.POST, uri, body, apiKey);
    }

    public Response put(URI uri, Cookie apiKey)
    {
        validateParameter(uri);

        return executeRequestAndReturnResponse(HttpMethod.PUT, uri, null, apiKey);
    }
